...
public class PacketPlayOutPlayerInfo implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutPlayerInfo(EntityPlayer var2, IChatBaseComponent customListName) {
        this.a = EnumPlayerInfoAction.UPDATE_DISPLAY_NAME;
        this.b.add(new PacketPlayOutPlayerInfo.PlayerInfoData(var2.getProfile(), 0, var2.playerInteractManager.getGameMode(), customListName));
    }
