    ...
    private void o() {
        if (this.n()) {
            ...
            if (this.getOwner() != null) {
                BrewEvent event = new BrewEvent(this.world.getWorld().getBlockAt(this.position.getX(), this.position.getY(), this.position.getZ()), (BrewerInventory)this.getOwner().getInventory());
            ...
            //TODO
            FinishBrewEvent event = new FinishBrewEvent(this.world.getWorld().getBlockAt(this.position.getX(), this.position.getY(), this.position.getZ()), (BrewerInventory)this.getOwner().getInventory());
            Bukkit.getPluginManager().callEvent(event);
        }
