...
public class EntityFallingBlock extends Entity {
    ...
    //TODO
    public Runnable onDropItem = null;

    public EntityFallingBlock(World world) {
        this((Location)null, world);
    }
    ...
    public EntityFallingBlock(World world, double d0, double d1, double d2, IBlockData iblockdata) {
        this((Location)null, world, d0, d1, d2, iblockdata);
    }

    public EntityFallingBlock(Location loc, World world, double d0, double d1, double d2, IBlockData iblockdata) {
        super(world);
        this.dropItem = true;
        this.fallHurtMax = 40;
        this.fallHurtAmount = 2.0F;
    ...
    public void t_() {
        ...
        if (block.getMaterial() == Material.AIR) {
            ...
            if (this.world.paperSpigotConfig.fallingBlockHeightNerf != 0 && this.locY > (double)this.world.paperSpigotConfig.fallingBlockHeightNerf) {
                if (this.dropItem) {
                    ...
                    if (this.world.getType(blockposition).getBlock() != Blocks.PISTON_EXTENSION) {
                        ...
                        if (!this.e) {
                            if (this.world.a(block, blockposition, true, EnumDirection.UP, (Entity)null, (ItemStack)null) && !BlockFalling.canFall(this.world, blockposition.down()) && blockposition.getX() >= -30000000 && blockposition.getZ() >= -30000000 && blockposition.getX() < 30000000 && blockposition.getZ() < 30000000 && blockposition.getY() >= 0 && blockposition.getY() < 256 && this.world.getType(blockposition) != this.block) {
                                ...
                                //TODO
                                if(onDropItem!=null){
                                    //if(motX<0.05 && motZ<0.05) { //Removed for throw net not bounce
                                        onDropItem.run();
                                        this.die();
                                    //}
                                    return;
    ...
    protected void a(NBTTagCompound nbttagcompound) {
        ...
        if (nbttagcompound.hasKey("SourceLoc_x")) {
            ...
            this.sourceLoc = new Location(this.world.getWorld(), (double)srcX, (double)srcY, (double)srcZ);
        }
    ...
    public double f(double d0, double d1, double d2) {
        if (!this.world.paperSpigotConfig.fixCannons) {
            ...
            double d4 = this.locY + (double)this.getHeadHeight() - d1;
    ...
    //TODO
    public void setOnDropItem(Runnable onDropItem) {
