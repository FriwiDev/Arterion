...
public class PacketPlayOutScoreboardTeam implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutScoreboardTeam(String team, String color, String displayName, String prefix, String suffix, Collection<String> var2, int var3) {
        if(var3==0||var3==1||var3==2){
            ...
            if (var3 == 0 || var3 == 2) {
                ...
                this.c = prefix;
                this.d = suffix;
                this.i = 0; //Friendly fire and visibility flags
                this.e = EnumNameTagVisibility.ALWAYS.e;
                this.f = EnumChatFormat.valueOf(color.toUpperCase()).b();
            }
