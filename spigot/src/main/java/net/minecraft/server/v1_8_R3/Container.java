    ...
    public ItemStack clickItem(int i, int j, int k, EntityHuman entityhuman) {
        ...
        if (k == 5) {
            ...
            if ((i1 != 1 || this.g != 2) && i1 != this.g) {
                ...
                Slot slot = i < this.c.size() ? (Slot)this.c.get(i) : null;
                ...
                if (!this.h.isEmpty()) {
                    ...
                    Iterator var15 = draggedSlots.entrySet().iterator();

                    while(var15.hasNext()) {
                        Entry<Integer, ItemStack> ditem = (Entry)var15.next();
                    ...
                    if (event.getResult() != Result.DENY) {
                        ...
                        while(var18.hasNext()) {
                            Entry<Integer, ItemStack> dslot = (Entry)var18.next();
            ...
            if ((k == 0 || k == 1) && (j == 0 || j == 1)) {
                ...
                if (i == -999) {
                    if (playerinventory.getCarried() != null) {
                        ...
                        if (j == 1) {
                            itemstack4 = playerinventory.getCarried();
                    ...
                    if (slot2 != null) {
                        ...
                        if (itemstack1 == null) {
                            ...
                            if (itemstack4 == null) {
                                ...
                                k1 = itemstack1.count;
                                maxStack = Math.min(itemstack4.getMaxStackSize(), slot2.getMaxStackSize());
                ...
                if (itemstack1 != null && (slot2 == null || !slot2.hasItem() || !slot2.isAllowed(entityhuman))) {
                    ...
                    for(int l1 = 0; l1 < 2; ++l1) {
                        for(maxStack = l; maxStack >= 0 && maxStack < this.c.size() && itemstack1.count < itemstack1.getMaxStackSize(); maxStack += k1) {
                            Slot slot3 = (Slot)this.c.get(maxStack);
