...
public class MightyHitHotbarCard extends HotbarCard implements PriorityHotbarCard, NotForModUser {
    MightyHitSkill.MightyHitSkillContainerData data;

    public MightyHitHotbarCard(long duration, MightyHitSkill.MightyHitSkillContainerData data) {
        super(duration);
        this.data = data;
    }
