...
public class WitherDamageHandler implements DamageHandler {

    @Override
    public void handleDamage(Entity damaged, Entity damager, EntityDamageEvent evt) {
        DamageManager.applyDamage(evt, ArterionPlugin.getInstance().getFormulaManager().DMG_WITHER.evaluateDouble(), false);
    }
}
