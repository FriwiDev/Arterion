...
public class LanguageHelper {
     ...
     */
    public static String getItemDisplayName(ItemStack item, EnumLang locale) {
     ...
     */
    public static String getItemName(ItemStack item, EnumLang locale) {
     ...
     */
    public static String getEntityDisplayName(Entity entity, EnumLang locale) {
     ...
     */
    public static String getEntityName(Entity entity, EnumLang locale) {
     ...
     * @return The localized name. if the entity doesn't have a localized name, this method will return the unlocalized name of it.
     */
    public static String getEntityName(EntityType entityType, EnumLang locale) {
     ...
     * @return The name of the level.(if level is greater than 10, it will only return the number of the level)
     */
    public static String getEnchantmentLevelName(int level, EnumLang locale) {
     ...
     * @return The name of the enchantment
     */
    public static String getEnchantmentName(Enchantment enchantment, EnumLang locale) {
     ...
     * @return The name of the item
     */
    public static String getEnchantmentDisplayName(Enchantment enchantment, int level, EnumLang locale) {
     ...
     * @return The name of the item
     */
    public static String getEnchantmentDisplayName(Map.Entry<Enchantment, Integer> entry, EnumLang locale) {
     ...
     */
    public static String translateToLocal(String unlocalizedName, EnumLang locale) {
        Map<String, String> map = locale.getMap();
