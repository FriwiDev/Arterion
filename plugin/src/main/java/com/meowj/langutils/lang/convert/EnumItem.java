...
public enum EnumItem {
    ...
    CARROT_ITEM(Material.CARROT_ITEM, "item.carrots.name"),
    CARROT(Material.CARROT, "item.carrots.name"),
    ...
    PRISMARINE(Material.PRISMARINE, 0, "tile.prismarine.rough.name"),
    PRISMARINE_BRICKS(Material.PRISMARINE, 1, "tile.prismarine.bricks.name"),
    PRISMARINE_DARK(Material.PRISMARINE, 2, "tile.prismarine.dark.name"),
    ...
    public static String getPlayerSkullName(ItemStack skull, EnumLang locale) {
